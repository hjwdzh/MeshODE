...
python ../src/python/optimize_rigid_deform.py ../data/source.obj ../data/reference.obj ./rigid_output.obj
python ../src/python/optimize_cad_fast_deform.py ../data/cad.obj ../data/reference.obj ./cad_output.obj
```
